 (function( $ ) {
        $(function() {
            $('.widget-description').each(function() {
				var url_yes= $(this).html();
				
				if(url_yes.indexOf("http") > 0 ){
                 $(this).html( '<img style="max-width:100%; height:auto;" src="'+$(this).html()+'" />')}
            });
		$("body").on('click','.btnsss', function(){
	$(this).next(".searchbox").slideToggle(500);
	
	if($(this).hasClass("opne")){
		$(this).removeClass("opne");
	$(this).children("span").html("+展开")
	}else{$(this).addClass("opne");$(this).children("span").html("-收起");}
	});
        });
    })( jQuery );
