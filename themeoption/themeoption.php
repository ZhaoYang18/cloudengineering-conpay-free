...
<div id="message" class="update-nag"><p><strong><?php echo $post; ?></strong></p>
 <p>主题名称：<?php echo $ct->display('Name'); ?> |  版本：<?php echo $ct->display('Version'); ?> | <a target="_blank" href="https://www.themepark.com.cn/ydqywoocommercesczt.html">[主题介绍和演示]</a></p>
 <p>需要帮助？我们为你录制了细致的视频教程,点击前往：<br />
<a target="_blank" href=" https://www.themepark.com.cn/ydqywoocommercescztptspj.html">主题专用视频教程(关于这款主题专门录制的教程)</a><br /><br />

<a target="_blank" href="https://www.themepark.com.cn/ydqywoocommercesczt.html">【您现在使用的主题是普通版本，若你想要在你的网站上建立一个线上销售系统，可以升级到woocommerce商城版本】</a>
</p></div>	
	<?php 
	}
