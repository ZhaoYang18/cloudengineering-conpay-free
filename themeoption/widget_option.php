...
?>
 ...
 <h3>【付费版解锁】主题边栏设置</h3>
 <p>付费版可以建立多个侧边栏位置，如企业新闻和企业产品的侧边栏可以显示不一样的内容，这有利于SEO优化，更有利于用户进入新闻或者产品等分类时的拓展阅读，付费版可解锁此功能，免费版只有一个默认的小工具位置，即全站显示的侧边栏内容一样。</p>
      ...
      <tbody>
        <tr>
               <th scope="row"><label for="themepark_theme_widget">添加侧边栏位置</label>
                ...
                <td>
                <input readonly="readonly"  type="text" size="60"   value=""/> 
