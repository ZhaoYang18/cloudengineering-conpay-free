  ...
  <form method="post" action="<?php echo admin_url('admin.php?page=bq_404_option'); ?>"class="xuanxiangka">
   ...
   <table class="form-table">
      <tbody>
          ...
          <tr>
               <th scope="row"><label for="error_404_move">404页面移动设备访问编辑【付费版解锁】</label>
                </th>
                <td>
                  <br />

                 <p>付费版是响应式设计，可以独立设置404的移动版状态</p>
                </td>
            </tr>
             ...
             <tr>
               <th scope="row"><label for="mytheme_fenxiang_show">底部版权显示区域</label>
                ...
                <td>
                 ...
                 <input type="checkbox" id="mytheme_fenxiang_show" readonly="readonly" name="mytheme_fenxiang_show[]" />在商品页显示[升级到商城版本可选]
                </td>
            </tr>
