...
?>
<h3>woocommerce产品系统多语言替换【商城付费版可用】</h3>
  ...
  <table class="form-table">
      ...
      <tr>
       <th scope="row"><label for="product_l1">返回</label>
                ...
                <td>
               <input readonly="readonly" type="text" size="60"  name="product_l1" id="product_l1" value="<?php echo $product_l1; ?>"/>  <br />
          ...
          <th scope="row"><label for="product_l2">筛选</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_l2" id="product_l2" value="<?php echo $product_l2; ?>"/>  <br />
          ...
          <tr>  
           <th scope="row"><label for="product_l3">点击筛选</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_l3" id="product_l3" value="<?php echo $product_l3; ?>"/>  <br />
          ...
          <tr>  
           ...
           <th scope="row"><label for="product_d1">产品对比</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_d1" id="product_d1" value="<?php echo $product_d1; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_d2">隐藏</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_d2" id="product_d2" value="<?php echo $product_d2; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_d3">最多对比4个</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_d3" id="product_d3" value="<?php echo $product_d3; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_d4">至少添加2个</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_d4" id="product_d4" value="<?php echo $product_d4; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_d5">开始对比</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_d5" id="product_d5" value="<?php echo $product_d5; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_d6">清除全部</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_d6" id="product_d6" value="<?php echo $product_d6; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_d7">展开全部</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_d7" id="product_d7" value="<?php echo $product_d7; ?>"/>  <br />
          ...
          <tr id="title">
           ...
           <th scope="row"><label for="product_l4">专柜价：</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_l4" id="product_l4" value="<?php echo $product_l4; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_l5">折扣价：</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_l5" id="product_l5" value="<?php echo $product_l5; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_l6">累计销量：</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_l6" id="product_16" value="<?php echo $product_l6; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_l7">累计评价：</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_l7" id="product_17" value="<?php echo $product_l7; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_l8">立即购买</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_l8" id="product_18" value="<?php echo $product_l8; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_l9">放入购物车</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_l9" id="product_19" value="<?php echo $product_l9; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_l0">推荐搭配</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_l0" id="product_10" value="<?php echo $product_l0; ?>"/>  <br />
              ...
              <tr>  
           <th scope="row"><label for="product_l1">你可能还喜欢</label>
                </th>
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_l1" id="product_11" value="<?php echo $product_l1; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_l12">购买商品</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_l12" id="product_112" value="<?php echo $product_l12; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_l13">分类信息</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_l13" id="product_113" value="<?php echo $product_l13; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_l14">商品参数</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_l14" id="product_114" value="<?php echo $product_l14; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_l15">商品描述</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_l15" id="product_115" value="<?php echo $product_l15; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_l16">商品评价</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_l16" id="product_116" value="<?php echo $product_l16; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_l17">购买商品</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_l17" id="product_117" value="<?php echo $product_l17; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_l18">配送到</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_l18" id="product_118" value="<?php echo $product_l18; ?>"/>  <br />
           ...
           <th scope="row"><label for="product_l19">包邮</label>
                ...
                <td>
               <input  type="text" readonly="readonly"  size="60"  name="product_l19" id="product_119" value="<?php echo $product_l19; ?>"/>  <br />
