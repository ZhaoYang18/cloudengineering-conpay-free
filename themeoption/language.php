...
function language_option_function(){
	...
	$language_c8  = trim($_POST['language_c8']);
	...
	$update_main_text    = array();
	 ...
	 $update_main_queries[] = update_option('language_c8', $language_c8);
...
$language_c8 = get_option('language_c8');
 ...
 <tr>
       ...
       <tr id="category">
            ...
            <tr>
               ...
               <th scope="row"><label for="language_c8">前往购买</label>
                </th>
                <td>
               <input  type="text" size="60"  name="language_c8" id="language_c8" value="<?php echo $language_c8; ?>"/>  <br />

                 <p>当你启用文章的产品展示模式时，会有一个按钮显示前往购买，你可以在此修改这个按钮的文字</p>
                </td>
            </tr>
         ...
         <!-------------------------------index---------------------------------------------------------------->   
           ...
           <tr>
            ...
            <tr>
               <th scope="row"><label for="language_pl1">您好！</label>
                ...
                <td>
               <input  type="text" size="60"  name="language_pl1" id="language_pl1" value="<?php echo $language_pl1; ?>"/>  <br />
          ...
          <tr>
               <th scope="row"><label for="language_pl2">请登录后评论</label>
                ...
                <td>
               <input  type="text" size="60"  name="language_pl2" id="language_pl2" value="<?php echo $language_pl2; ?>"/>  <br />
           ...
           <tr>
               <th scope="row"><label for="language_pl3">请登录</label>
                ...
                <td>
               <input  type="text" size="60"  name="language_pl3" id="language_pl3" value="<?php echo $language_pl3; ?>"/>  <br />
           ...
           <tr>
               <th scope="row"><label for="language_pl4">点击取消回复</label>
                ...
                <td>
               <input  type="text" size="60"  name="language_pl4" id="language_pl4" value="<?php echo $language_pl4; ?>"/>  <br />
            ...
            <tr>
               <th scope="row"><label for="language_pl5">称呼</label>
                ...
                <td>
               <input  type="text" size="60"  name="language_pl5" id="language_pl5" value="<?php echo $language_pl5; ?>"/>  <br />
              ...
              <tr>
               <th scope="row"><label for="language_pl6">邮箱</label>
                ...
                <td>
               <input  type="text" size="60"  name="language_pl6" id="language_pl6" value="<?php echo $language_pl6; ?>"/>  <br />
              ...
              <tr>
               <th scope="row"><label for="language_pl7">添加表情</label>
                </th>
                <td>
               <input  type="text" size="60"  name="language_pl7" id="language_pl7" value="<?php echo $language_pl7; ?>"/>  <br />
              ...
              <tr>
               <th scope="row"><label for="language_pl8">发布评论</label>
                ...
                <td>
               <input  type="text" size="60"  name="language_pl8" id="language_pl8" value="<?php echo $language_pl8; ?>"/>  <br />
              ...
              <tr>
               <th scope="row"><label for="language_pl9">评论审核中</label>
                ...
                <td>
               <input  type="text" size="60"  name="language_pl9" id="language_pl9" value="<?php echo $language_pl9; ?>"/>  <br />
               ...
               <th scope="row"><label for="language_pl9">回复</label>
                ...
                <td>
               <input  type="text" size="60"  name="language_pl0" id="language_pl0" value="<?php echo $language_pl0; ?>"/>  <br />
