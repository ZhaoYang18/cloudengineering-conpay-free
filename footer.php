...
<div class="footer_in">
    ...
    |  <a class="gonganwb" target="_blank" rel="nofollow" href="<?php echo $mytheme_footer_bqba_ts4; ?>"><?php echo $mytheme_footer_bqba_ts3; ?></a>
       <?php } ?>
        <?php if($mytheme_footer_bqba_ts5!='none'){?> 
      |  <a target="_blank" href="http://www.themepark.com.cn"><?php if($mytheme_footer_bqba_ts5){echo $mytheme_footer_bqba_ts5;}else{echo '技术支持： WEB主题公园 ';} ?></a> </p>
   <?php } ?>
   <?php  
